  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light shadow-sm  bg-body rounded px-5">
      <div className="container-fluid">
        <h4 ame="navbar-brand ps-5">SHOPNOW</h4>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 ps-4">
            <li className="nav-item">
              <p className="nav-link active me-3 pt-3" aria-current="page">
            ...
            <li className="nav-item ">
              <p className="nav-link me-3 pt-3" aria-current="page">
            ...
            <li className="nav-item">
              <p className="nav-link me-3 pt-3">
